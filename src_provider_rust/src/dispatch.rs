...
pub static AKV_STORE_FUNCTIONS: [OsslDispatch; 8] = [
    OsslDispatch::new(OSSL_FUNC_STORE_OPEN, crate::akv_store_open as *mut c_void),
    OsslDispatch::new(
    ...
    OsslDispatch::new(OSSL_FUNC_STORE_LOAD, crate::akv_store_load as *mut c_void),
    OsslDispatch::new(OSSL_FUNC_STORE_EOF, crate::akv_store_eof as *mut c_void),
    OsslDispatch::new(OSSL_FUNC_STORE_CLOSE, crate::akv_store_close as *mut c_void),
    OsslDispatch::end(),
];
...
pub static AKV_RSA_KEYMGMT_FUNCTIONS: [OsslDispatch; 15] = [
    OsslDispatch::new(
        ...
        crate::keymgmt::akv_keymgmt_new as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_FREE,
        crate::keymgmt::akv_keymgmt_free as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_LOAD,
        crate::keymgmt::akv_keymgmt_load as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_HAS,
        crate::keymgmt::akv_keymgmt_has as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_MATCH,
        crate::keymgmt::akv_keymgmt_match as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_GET_PARAMS,
        crate::keymgmt::akv_keymgmt_get_params as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_GETTABLE_PARAMS,
        crate::keymgmt::akv_rsa_keymgmt_gettable_params as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_SET_PARAMS,
        crate::keymgmt::akv_keymgmt_set_params as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_SETTABLE_PARAMS,
        crate::keymgmt::akv_rsa_keymgmt_settable_params as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_IMPORT,
        crate::keymgmt::akv_rsa_keymgmt_import as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_IMPORT_TYPES,
        crate::keymgmt::akv_rsa_keymgmt_eximport_types as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_EXPORT,
        crate::keymgmt::akv_keymgmt_export as *mut c_void,
    ),
    OsslDispatch::new(
    ...
    OsslDispatch::new(
        ...
        crate::keymgmt::akv_rsa_keymgmt_query as *mut c_void,
    ),
    OsslDispatch::end(),
];
...
pub static AKV_EC_KEYMGMT_FUNCTIONS: [OsslDispatch; 15] = [
    ...
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_GETTABLE_PARAMS,
        crate::keymgmt::akv_ec_keymgmt_gettable_params as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_SET_PARAMS,
        crate::keymgmt::akv_keymgmt_set_params as *mut c_void,
    ...
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_SETTABLE_PARAMS,
        crate::keymgmt::akv_ec_keymgmt_settable_params as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_IMPORT,
        crate::keymgmt::akv_ec_keymgmt_import as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_IMPORT_TYPES,
        crate::keymgmt::akv_ec_keymgmt_eximport_types as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_EXPORT,
        crate::keymgmt::akv_keymgmt_export as *mut c_void,
    ...
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_QUERY_OPERATION_NAME,
        crate::keymgmt::akv_ec_keymgmt_query as *mut c_void,
    ),
    OsslDispatch::end(),
];
...
pub static AKV_AES_KEYMGMT_FUNCTIONS: [OsslDispatch; 10] = [
    ...
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_FREE,
        crate::keymgmt::akv_aes_keymgmt_free as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_LOAD,
        crate::keymgmt::akv_aes_keymgmt_load as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_HAS,
        crate::keymgmt::akv_aes_keymgmt_has as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_MATCH,
        crate::keymgmt::akv_aes_keymgmt_match as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_GET_PARAMS,
        crate::keymgmt::akv_aes_keymgmt_get_params as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_GETTABLE_PARAMS,
    ...
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_IMPORT,
        crate::keymgmt::akv_aes_keymgmt_import as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_KEYMGMT_IMPORT_TYPES,
        crate::keymgmt::akv_aes_keymgmt_import_types as *mut c_void,
    ),
    OsslDispatch::end(),
];
...
pub static AKV_RSA_SIGNATURE_FUNCTIONS: [OsslDispatch; 22] = [
    ...
    OsslDispatch::new(
        ...
        crate::signature::akv_signature_verify_init as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_SIGNATURE_SIGN,
        crate::signature::akv_signature_sign as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_SIGNATURE_VERIFY,
        crate::signature::akv_signature_verify as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_SIGNATURE_DIGEST_SIGN_INIT,
        crate::signature::akv_signature_digest_sign_init as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_SIGNATURE_DIGEST_VERIFY_INIT,
        crate::signature::akv_signature_digest_verify_init as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_SIGNATURE_DIGEST_SIGN_UPDATE,
        crate::signature::akv_signature_digest_update as *mut c_void,
    ),
    OsslDispatch::new(
    ...
    OsslDispatch::new(
        ...
        crate::signature::akv_signature_digest_sign_final as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_SIGNATURE_DIGEST_VERIFY_FINAL,
        crate::signature::akv_signature_digest_verify_final as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_SIGNATURE_DIGEST_SIGN,
        crate::signature::akv_signature_digest_sign as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_SIGNATURE_GET_CTX_PARAMS,
        crate::signature::akv_signature_get_ctx_params as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_SIGNATURE_GETTABLE_CTX_PARAMS,
        crate::signature::akv_signature_gettable_ctx_params as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_SIGNATURE_SET_CTX_PARAMS,
        crate::signature::akv_signature_set_ctx_params as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_SIGNATURE_SETTABLE_CTX_PARAMS,
        crate::signature::akv_signature_settable_ctx_params as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_SIGNATURE_GET_CTX_MD_PARAMS,
        crate::signature::akv_signature_get_ctx_md_params as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_SIGNATURE_GETTABLE_CTX_MD_PARAMS,
        crate::signature::akv_signature_gettable_ctx_md_params as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_SIGNATURE_SET_CTX_MD_PARAMS,
        crate::signature::akv_signature_set_ctx_md_params as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_SIGNATURE_SETTABLE_CTX_MD_PARAMS,
        crate::signature::akv_signature_settable_ctx_md_params as *mut c_void,
    ),
    OsslDispatch::end(),
];
...
pub static AKV_RSA_ASYM_CIPHER_FUNCTIONS: [OsslDispatch; 11] = [
    OsslDispatch::new(
        ...
        crate::cipher::akv_rsa_cipher_newctx as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_ASYM_CIPHER_FREECTX,
        crate::cipher::akv_rsa_cipher_freectx as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_ASYM_CIPHER_ENCRYPT_INIT,
        crate::cipher::akv_rsa_cipher_encrypt_init as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_ASYM_CIPHER_ENCRYPT,
        crate::cipher::akv_rsa_cipher_encrypt as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_ASYM_CIPHER_DECRYPT_INIT,
        crate::cipher::akv_rsa_cipher_decrypt_init as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_ASYM_CIPHER_DECRYPT,
        crate::cipher::akv_rsa_cipher_decrypt as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_ASYM_CIPHER_GET_CTX_PARAMS,
        crate::cipher::akv_rsa_cipher_get_ctx_params as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_ASYM_CIPHER_GETTABLE_CTX_PARAMS,
        crate::cipher::akv_rsa_cipher_gettable_ctx_params as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_ASYM_CIPHER_SET_CTX_PARAMS,
        crate::cipher::akv_rsa_cipher_set_ctx_params as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_ASYM_CIPHER_SETTABLE_CTX_PARAMS,
        crate::cipher::akv_rsa_cipher_settable_ctx_params as *mut c_void,
    ),
    OsslDispatch::end(),
];
...
pub static AKV_AES_ASYM_CIPHER_FUNCTIONS: [OsslDispatch; 11] = [
    OsslDispatch::new(
        OSSL_FUNC_ASYM_CIPHER_NEWCTX,
        crate::cipher::akv_aes_cipher_newctx as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_ASYM_CIPHER_FREECTX,
        crate::cipher::akv_aes_cipher_freectx as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_ASYM_CIPHER_ENCRYPT_INIT,
        crate::cipher::akv_aes_cipher_encrypt_init as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_ASYM_CIPHER_ENCRYPT,
        crate::cipher::akv_aes_cipher_encrypt as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_ASYM_CIPHER_DECRYPT_INIT,
        crate::cipher::akv_aes_cipher_decrypt_init as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_ASYM_CIPHER_DECRYPT,
        crate::cipher::akv_aes_cipher_decrypt as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_ASYM_CIPHER_GET_CTX_PARAMS,
        crate::cipher::akv_aes_cipher_get_ctx_params as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_ASYM_CIPHER_GETTABLE_CTX_PARAMS,
        crate::cipher::akv_aes_cipher_gettable_ctx_params as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_ASYM_CIPHER_SET_CTX_PARAMS,
        crate::cipher::akv_aes_cipher_set_ctx_params as *mut c_void,
    ),
    OsslDispatch::new(
        OSSL_FUNC_ASYM_CIPHER_SETTABLE_CTX_PARAMS,
        crate::cipher::akv_aes_cipher_settable_ctx_params as *mut c_void,
    ),
    OsslDispatch::end(),
];
